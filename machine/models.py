...
class Venda(models.Model):
    ...
    previsao_pgto = models.DateField(default=timezone.now)
    valor_bruto = models.DecimalField(max_digits=8, decimal_places=2, default=0.00)
    taxa = models.DecimalField(max_digits=8, decimal_places=2, default=0.00)
    valor_tarifa = models.DecimalField(max_digits=8, decimal_places=2, default=0.00)
    valor_cobranca = models.DecimalField(max_digits=8, decimal_places=2, default=0.00)
    valor_devido = models.DecimalField(max_digits=8, decimal_places=2, default=0.00)
    ...
    valor_contestado = models.DecimalField(max_digits=8, decimal_places=2, default=0.00)
